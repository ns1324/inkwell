...
- **2a.** No posts exist yet: system shows an explicit empty state, not a blank screen (a real requirement, not a cosmetic afterthought). An un tested empty state is a common source of embarrassing production bugs.
